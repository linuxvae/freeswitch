...
class AgoraSdk : virtual public agora::recording::IRecordingEngineEventHandler {
    ...
    protected:
        ...
        virtual void onWarning(int warn, agora::linuxsdk::WARN_REASON_TYPE reason) {
            onWarningImpl(warn, reason);
        }
    ...
    protected:
        ...
        void onWarningImpl(int warn, agora::linuxsdk::WARN_REASON_TYPE reason);
