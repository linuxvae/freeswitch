...
enum WARN_CODE_TYPE {
    ...
    WARN_INTERNAL_CODE_BASE = 100000,
    WARN_NO_AUDIO_FRAME_RECEIVED = 1 + WARN_INTERNAL_CODE_BASE,
    WARN_RECEIVED_AUDIO_FRAME = 2 + WARN_INTERNAL_CODE_BASE,
    WARN_NO_VIDEO_FRAME_RECEIVED = 3 + WARN_INTERNAL_CODE_BASE,
    WARN_RECEIVED_VIDEO_FRAME = 4 + WARN_INTERNAL_CODE_BASE,
};

enum WARN_REASON_TYPE {
    //audio frame
    WARN_REASON_PCM_FRAME_MISSED = 1<<0,

    //WARN_REASON_video WARN_REASON_frame
    WARN_REASON_ENC_VIDEO_FRAME_MISSED = 1<<1,
    WARN_REASON_YUV_FRAME_MISSED = 1<<2,
    WARN_REASON_JPG_FRAME_MISSED = 1<<3,

    WARN_REASON_NO_BITMAP = 1<<20,
    WARN_REASON_RESERVE = WARN_REASON_NO_BITMAP + 1,
};
